...
module params
   ...
   real, parameter:: dt = float(99)/float(tn)
   ...
   character(len=50), parameter:: fname = "result.nc"
...
module variables
   ...
   ! timesteps array
   real*8, dimension(1:tn):: ts

   real*8, dimension(1:ns, 1:ns):: xx, yy, zz

   ! wave function solution
   real*8, dimension(1:ns, 1:ns, 1:tn):: psi
   ! electron density
   real*8, dimension(1:ns, 1:ns, 1:tn):: psi2
